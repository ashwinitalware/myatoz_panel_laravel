                ...
                <div class="row">
                    <div class="col-md-12" style="margin-top:-15px;">
                        <!-- START DEFAULT TABLE -->
                                ...
                                @endif
                        <div class="panel panel-default">
                                <h5 class="panel-title" style="color:#FFFFFF; background-color:#8b1212; width:100%; font-size:14px;" align="center"><i class="fa fa-list-alt"></i> &nbsp;Add City</h5>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group" style="margin-top:-10px;">  
                                                ...
                                                <div class="col-md-2" style="margin-top:15px;">
                                                    <label>Add City<font color="#FF0000">*</font></label>
                                                    <input type="text" name="city" placeholder="Add City" class="form-control" required/>
                                                </div>
                        ...
                        <div class="panel-body" style="margin-top:-10px; margin-bottom:-15px;">
                            <table class="table datatable">
                                ...
                                @forelse($All_Cities as $key => $cities)
                                    ...
                                    <a href="Javascript:void(0)" class="btn btn-outline-danger  btn-sm faIconsInList openDeleteModal" title="Delete" data-deleteMOdalText="Are you sure you want to delete this?" data-deleteUrl="{{ route('city.destroy', $cities->id) }}">
