                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default" style="overflow-x:scroll;">
                                ...
                                <div class="col-md-12" style="margin-top:15px;">
                                    <h5 class="panel-title" style="color:#FFFFFF; background-color:#8b1212; width:100%; font-size:14px;" align="center"><i class="fa fa-credit-card"></i> Current Rides</h5>
                                   <!-- {{$all_rides}} -->
                                <div class="panel-body" style="margin-top:-10px; margin-bottom:-15px;">
                                    <table class="table datatable">
                                        ...
                                        <tbody>
                                           ...
                                           <tr>
                                                <td>{{$i}}</td>
                                                <td>{!! !empty($data->driver_id)?'<span class="label label-success label-form">Ongoing Ride</span>':'<span class="label label-danger label-form">Pending</span>' !!}</td>
