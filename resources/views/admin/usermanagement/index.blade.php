...
@section('content')  
            ...
            <div class="row">
                <div class="col-md-12" style="margin-top:-15px;">
                    ...
                    @endif
                    <h5 class="panel-title"  style="color:#FFFFFF; background-color:#8b1212; width:100%; font-size:14px;" align="center"><span class="fa fa-list-alt"></span></i> &nbsp;User-Management</h5>


                    <form role="form" method="post" action="{{ route('usermanagement.store') }}">
                        @csrf
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group" style="margin-top:-10px; ">  
                                            ...
                                            <div class="col-md-2" style="margin-top:15px; margin-left: 10%;">
                                                ...
                                                <input type="text" placeholder="Password" name="password" class="form-control" required input/>
                                            </div>
                                            <div class="col-md-2" style="margin-top:15px; margin-left: 10%;">
                                                <label>Role Name<font color="#FF0000">*</font></label>
                                                <input type="text" placeholder="Role Name" name="role_name" class="form-control" required input/>
                                            </div>
                                       <div class="col-md-12">
                                        <div class="col-md-1" style="margin-top: 2%; ">
                                            <input type="checkbox" style="float:left" id="add1" name="dashboard" value="1">
                                            <label for="add0" ><font color="#FF0000">*&nbsp;</font>Dashboard 
                                            </label>
                                        </div>
                                      <div class="col-md-1" style="margin-top: 2%; ">
                                                <input type="checkbox" style="float:left" id="add1" name="city" value="1">
                                                <label for="add1" ><font color="#FF0000">*&nbsp;</font>Add city 
                                                </label>
                                            </div>

                                            <div class="col-md-1" style="margin-top: 2%; ">
                                                <input type="checkbox" style="float:left" id="add2" name="area" value="1">
                                            ...
                                            <div class="col-md-2" style="margin-top: 2%; ">
                                                <input type="checkbox" style="float:left" id="addm1" name="insurance" value="1">
                                            ...
                                            <div class="col-md-3" style="margin-top: 2%; ">
                                                <input type="checkbox" style="float:left" id="adds1" name="subscription" value="1">
                                            ...
                                            <div class="col-md-2" style="margin-top: 2%; ">
                                                <input type="checkbox" style="float:left" id="mode1" name="payment" value="1">
                                            ...
                                            <div class="col-md-1" style="margin-top: 2%; ">
                                                <input type="checkbox" style="float:left" id="driver1" name="driver" value="1">
                                            ...
                                            <div class="col-md-1" style="margin-top: 2%; ">
                                                <input type="checkbox" style="float:left" id="customer1" name="customer" value="1">
                                       ...
                                       <div class="col-md-12">
                                            <div class="col-md-1" style="margin-top: 2%; ">
                                                <input type="checkbox" style="float:left" id="account1" name="account" value="1">
                                            ...
                                            <div class="col-md-1" style="margin-top: 2%; ">
                                                <input type="checkbox" style="float:left" id="contact1" name="contact_us" value="1">
                                            ...
                                            <div class="col-md-1" style="margin-top: 2%; ">
                                                <input type="checkbox" style="float:left" id="user1" name="timeslot" value="1">
                                            ...
                                            <div class="col-md-1" style="margin-top: 2%; ">
                                                <input type="checkbox" style="float:left" id="user1" name="timetable" value="1">
                                            ...
                                            <div class="col-md-1" style="margin-top: 2%; ">
                                                <input type="checkbox" style="float:left" id="user1" name="notes" value="1">
                                            ...
                                            <div class="col-md-2" style="margin-top: 2%; ">
                                                <input type="checkbox" style="float:left" id="usermanegment1" name="usermanegment" value="1">
                                            ...
                                            <div class="col-md-2" style="margin-top: 2%; ">
                                                <input type="checkbox" style="float:left" id="addemp1" name="employee" value="1">
                                            ...
                                            <div class="col-md-1" style="margin-top: 2%; ">
                                                <input type="checkbox"  style="float:left" id="reports1" name="reports" value="1">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                style="margin-top: 13%;"> Submit</button></a>
                                             </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>@if($usermanagement->role == 1)
                                            ...
                                            @else
                                            <a href="{{ route('usermanagement.edit', $usermanagement->id) }}" class="btn btn-outline-primary btn-sm  faIconsInList" title="Edit">
