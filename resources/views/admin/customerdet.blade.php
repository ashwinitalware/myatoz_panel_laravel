                               ...
                               <div class="panel-body">
                                    <!-- <div class="form-group">
                                        ...
                                        <!-- <div class="col-md-12" style="margin-bottom:-5px;" align="center">
                                           ...
                                           <a href="emplyoeereg.html"> <button type="button" class="btn active" style="background-color:#006699; color:#FFFFFF"></i>Employee Registration</button></a>
                                          
                                           <a href="employeedet.html"><button type="button" class="btn active" style="background-color:#18020b; color:#FFFFFF"></i>Employee Details</button></a>
                                           <a href="customerdet.html"><button type="button" class="btn active" style="background-color:#66223d; color:#FFFFFF"></i>Customer Details</button></a>
                                           <a href="meassage.html"><button type="button" class="btn active" style="background-color :#924a62; color:#FFFFFF"></i>Message</button></a>
                  ...
                  <div class="row">
                	 ...
                	 <!-- START DEFAULT DATATABLE -->
                           ...
                           <!--  <div class="panel panel-default">
                                    ...
                                    <h5 class="panel-title" style="color:#FFFFFF; background-color:#8b1212; width:100%; font-size:14px;" align="center"><i class="fa fa-users"></i> &nbsp;Customer Details</h5>
                                ...
                                <div class="panel-body" style="margin-top:-10px; margin-bottom:-5px;">
                                    <div class="form-group"> 
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group" style="margin-top:-10px;">   
                                               ...
                                               <div class="col-md-2" style="margin-top:15px;">
                                                    ...
                                                    <input type="text" placeholder="Customer Name" class="form-control" required input/>
                                                </div> 

                                                <div class="col-md-2" style="margin-top:15px;">
                                                	<label>Card No.<font color="#FF0000">*</font></label>
                                                    <input type="text" placeholder="Card no." class="form-control" required input/>
                                                </div> 
                                                
                                                <div class="col-md-2" style="margin-top:15px;">
                                                	<label>Customer Id<font color="#FF0000">*</font></label>
                                                    <input type="text" placeholder="Customer Id" class="form-control" required input/>
                                                </div>
                                                <div class="col-md-2" style="margin-top:15px;">
                                        ...
                                        <div class="col-md-2"  align="center">
                                            ...
                                            <div class="input-group" style="margin-top:19px; margin-bottom:15px;">
