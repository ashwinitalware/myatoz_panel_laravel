                  ...
                  <div class="row">
                	 ...
                	 <!-- START DEFAULT DATATABLE -->
                            <div class="panel panel-default">
                                    ...
                                    <h5 class="panel-title" style="color:#FFFFFF; background-color:#8b1212; width:100%; font-size:14px;" align="center"><i class="fa fa-users"></i> Message</h5>
                                ...
                                <div class="panel-body" style="margin-top:-10px; margin-bottom:-5px;">
                                    <div class="form-group"> 
                                    	...
                                    	<form role="form">
                                        <div class="col-md-12">
                                           <!--  <div class="form-group" style="margin-top:-10px;"> -->                    <div class="col-md-2" style="margin-top:15px">
                                               ...
                                               <!--  </div>   -->
                                                	...
                                                	<label>Message<font color="#FF0000">*</font></label>
                                                     ...
                                                     <textarea name="Nominee_Detail" class="form-control" cols="4" rows="2"></textarea>
                                                     </div>
                                                ...
                                                <div class="col-md-2" align="left">
                                                    ...
                                                    <div class="input-group" style="margin-top:5vh; margin-bottom:15px;">
                                                    	...
                                                    	<button type="button" class="btn btn-primary"></span> Submit </button>
                                                    </div>
                                                </div>    
