                ...
                @section('content')  
                                ...
                                <div class="row">
                                    <div class="col-md-12" style="margin-top:-15px;">
                                        <!-- START DEFAULT TABLE -->
                                        <div class="panel panel-default">
                                                <h5 class="panel-title" style="color:#FFFFFF; background-color:#8b1212; width:100%; font-size:14px;" align="center"><i class="fa fa-list-alt"></i> &nbsp;Update Area</h5>
                                            <div class="panel-body" style="margin-top:-10px; margin-bottom:-5px;">
                                                <div class="form-group"> 
                                                    <form role="form" method="post" action="{{ route('area.update', $area->id) }}">
                                                    @csrf   
                                                    @method('PUT') 
                                                    <div class="col-md-12">
                                                            ...
                                                            @endforelse
                                                                ...
                                                                <div class="col-md-2" style="margin-top:15px;">
                                                                    <label>Update Area<font color="#FF0000">*</font></label>
                                                                    <input type="text" name="area" value="{{ @$area->area }}" placeholder="Add Area" class="form-control" required/>
                                                                </div>
                            ...
                            <table class="table datatable">
                                ...
                                @forelse($All_Areas as $key => $area)
                                    <tr>
                                        ...
                                        <td>{{$area->status}}</td>
                                        <td>
                                        <a href="{{ route('area.edit', $area->id) }}" class="btn btn-outline-primary btn-sm  faIconsInList" title="View">
