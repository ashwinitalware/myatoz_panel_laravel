    ...
    @endif
        <div class="panel panel-default">
            ...
            <h5 class="panel-title" style="color:#FFFFFF; background-color:#8b1212; width:100%; font-size:14px;"
                align="center"><i class="fa fa-users"></i> &nbsp;Driver Management</h5>
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <form role="form" method="post" action="{{ route('driver_management.store') }}">
                        @csrf
                        <div class="col-md-12">
                            <div class="form-group" style="margin-top:-10px;">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-12" style="margin-top:2px;">
                                        ...
                                        <div class="col-md-3" style="margin-top:10px;">
                                            <label> Search Driver<font color="#FF0000"></font></label>
                                            <select class="form-control select1" data-live-search="true" name="driver_id"
                                        ...
                                        <div class="col-md-3" style="margin-top:10px;">
                                            ...
                                            <input type="text" name="amount_per_km" placeholder="Enter Amount "
                                        ...
                                        <div class="col-md-3" align="left">
                                            ...
                                            <div class="input-group" style="margin-top:5vh">
                                                ...
                                                <button type="submit" class="btn btn-primary"></span> Submit </button>
                                            </div>
                                        </div>
                                    </div>
                    </form>
            ...
            <div class="row" id="adminList">
						...
						{{!empty($all_driver_management->drop_details) ? $all_driver_management->drop_details->area:''}}
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="Javascript:void(0)" class="btn btn-outline-danger  btn-sm faIconsInList openDeleteModal" title="Delete" data-deleteMOdalText="Are you sure you want to delete this?" data-deleteUrl="{{ route('driver_management.destroy', $all_driver_management->id) }}">
                                                            <button
            ...
            $('#city_id').change(function() {
                    ...
                    $.ajax({
                        headers: {
                            ...
                            type: "POST",
                            dataType: "json",
                            url: '{{ route('driver_management.get_drivers') }}',
                            data: {'city_id': city_id},
                            success: function(data){
                                console.log(data)
                                $("#driver_id").empty();
                                ...
                                console.log(first_name)
                                    ...
                                    $("#driver_id").append("<option value='"+id+"'>"+first_name+'  '+last_name+"</option>");
